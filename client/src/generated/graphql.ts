...
export type MediaFragmentFragment = { id: number, bannerImage: string | null, description: string | null, status: MediaStatus | null, episodes: number | null, genres: Array<string | null> | null, averageScore: number | null, popularity: number | null, title: { romaji: string | null, english: string | null, native: string | null } | null, coverImage: { large: string | null, extraLarge: string | null } | null, nextAiringEpisode: { airingAt: number, episode: number, timeUntilAiring: number } | null, mediaListEntry: { id: number, status: MediaListStatus | null, progress: number | null } | null, studios: { nodes: Array<{ id: number, name: string } | null> | null } | null, characters: { nodes: Array<{ id: number, name: { full: string | null, native: string | null } | null, image: { large: string | null } | null } | null> | null } | null };
