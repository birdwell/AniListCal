# AniList tag taxonomy reference

Static reference for AniList genre and tag categories. The app builds filter options dynamically from each user's anime list (`client/src/components/home/AnimeContent.tsx`); this file is not loaded at runtime.
